  ...
  return (
    <div className="space-y-4">
      <div className="relative">
        ...
        <Input
          placeholder={t('printerSelector.searchPlaceholder')}
          value={searchValue}
      ...
      <div className="space-y-2">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {printer.location_name && (
                <p className="text-xs text-slate-400 truncate">{t('common.location')}: {printer.location_name}</p>
              )}
            </div>
        ...
        {filteredPrinters.length === 0 && (
          <div className="text-center py-12 text-slate-500">
            ...
            <p>{t('printerSelector.noPrinters')}</p>
          </div>
        )}
      </div>
    </div>
